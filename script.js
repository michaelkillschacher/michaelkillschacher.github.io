document.addEventListener('DOMContentLoaded', function () {
  ...
  mobileHoverElement.addEventListener('mouseover', addTouchClasses);
  mobileHoverElement.addEventListener('mouseout', removeTouchClasses);
});
