...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var activateNextItem = function () {
      ...
      item.querySelector('.media.hovered').style.backgroundColor = 'rgb(0, 85, 95)'; //hindergrund box
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function updateImage(index) {
    const imageName = `battery.${addLeadingZeros(index, 4)}.png`;
    galleryContainer.innerHTML = `<img src="images/battery_connection/${imageName}" alt="world emissions">`;
  }

  function handleMouseOver() {
    updateImage(1); // Beim Hover das zweite Bild anzeigen
  }

  function handleMouseLeave() {
    updateImage(0); // Beim Verlassen des Hover das erste Bild anzeigen
  }

  // Event Listener für das Hover-Ereignis auf das Container-Div
  galleryContainer.addEventListener("mouseover", handleMouseOver);
